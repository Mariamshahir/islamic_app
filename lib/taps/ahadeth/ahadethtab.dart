    ...
    return Column(
      children: [
        Expanded(
          flex: 3,
          child: Center(
            child: Image.asset(AppAssets.ahadethTapLogo),
          ),
        ),
        Expanded(
          flex: 7,
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: Center(
            child: Text(
              context.getLocalizations.ahadeth,
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          ...
          child: Container(
            ...
            child: Text(
              hadethName,
              style: themeProvider.smallTitleTextStyle,
              textAlign: TextAlign.center,
            ),
          ),
        );
